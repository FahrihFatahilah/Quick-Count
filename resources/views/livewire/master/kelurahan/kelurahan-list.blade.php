                        ...
                        <div class="card-body">
                            <div class="card-title">
                                <div class="row">
                                    ...
                                    <div class="col-6">
                                        <a wire:navigate href="/kelurahan/create" class="btn btn-primary float-end">Add New</a>
                                    </div>
                                </div>
                            </div>
                            <div wire:poll.10s>
                                    ...
                                    <tbody>
                                        @foreach ($kelurahanList as $item)
                                            <tr>
                                                ...
                                                <td>{{ $item->kecamatan->name ?? 'No candidate found' }}</td>
                                                <td>
                                                    <a wire:navigate href="/kelurahan/{{ $item->id}}/edit" class="btn btn-sm btn-warning">Edit</a>
                                                    <button
